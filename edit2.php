...
<body>
	...
	<?php endif; ?>
	  <form style="margin-top: 3%;" id="form-maba" class="ui form" action="update.php" method="POST" enctype="multipart/form-data">
	  	<div class="ui grid">
		  	...
		  	<div class="seven wide column">
					...
					<?php
						...
						if (count($riwayat_pendidikan) > 0) {
							for ($i = 0; $i < count($riwayat_pendidikan); $i++) {
								echo '<div class="fields">
						  				<div class="field">
									  		...
									  		<input type="text" name="riwayat_pendidikan[' . $i . ']" value="'.$riwayat_pendidikan[$i].'" />
									  	</div>
									  	<div class="field">
									  		<label for="instansi">Tahun</label>
									  		<input type="text" name="tahun_pendidikan[' . $i . ']" value="'.$tahun_pendidikan[$i].'"/>
									  	</div>
						  			</div>';
							}
						} else {
							echo '<div class="fields">
						  				<div class="field">
									  		<label for="prestasi">Nama Sekolah</label>
									  		<input type="text" name="riwayat_pendidikan[0]"/>
									  	</div>
									  	<div class="field">
									  		<label for="instansi">Tahun</label>
									  		<input type="text" name="tahun_pendidikan[0]"/>
									  	</div>
						  			</div>';
						}
					?>
					...
					<?php 
						...
						if (count($riwayat_prestasi) > 0) {
							for ($i = 0; $i < count($riwayat_prestasi); $i++) {
								echo '<div class="fields">
						  				<div class="field">
									  		...
									  		<input type="text" name="riwayat_prestasi[' . $i . ']" value="'.$riwayat_prestasi[$i].'"/>
									  	</div>
									  	<div class="field">
									  		<label for="instansi">Tahun Prestasi</label>
									  		<input type="text" name="tahun_prestasi[' . $i . ']" value="'.$tahun_prestasi[$i].'"/>
									  	</div>
									  	<div class="field">
									  		<label for="instansi">Instansi Pemberi</label>
									  		<input type="text" name="pemberi_prestasi[' . $i . ']" value="'.$pemberi_prestasi[$i].'"/>
									  	</div>
						  			</div>';
							}
						} else {
							echo '<div class="fields">
									  	...
									  	<div class="field">
									  		<label for="instansi">Tahun Prestasi</label>
									  		<input type="text" name="tahun_prestasi[0]"/>
									  	</div>
									  	<div class="field">
									  		<label for="instansi">Instansi Pemberi</label>
									  		<input type="text" name="pemberi_prestasi[0]"/>
									  	</div>
						  			</div>';
						}
					?>
				...
				<div class="grouped fields">
					...
					<div class="field">
						<div class="ui radio checkbox">
							<input class="hidden" tabindex="0" name="isu" type="radio" value="Setuju" />
							<label>Setuju</label>
						</div>
					</div>
					<div class="field">
						<div class="ui radio checkbox">
							<input class="hidden" tabindex="0" name="isu" type="radio" value="Tidak Setuju" />
				...
				<center>
					<input class="ui positive button" name="update" type="submit" value="Simpan Perubahan" />
				</center>	
		  	</div>	
	  </form>
	  ...
	  <script type="text/javascript">
		...
		$("#tambah").click(function() {
			$("#wrapper").append('<div class="fields">' +
  				'<div class="field">' +
			  		'<label for="prestasi">Nama Prestasi</label>' +
			  		'<input type="text" name="riwayat_prestasi[' + i + ']"/>' +
			  	'</div>' +
			  	'<div class="field">' +
			  		'<label for="tahun">Tahun Prestasi</label>' +
			  		'<input type="text" name="tahun_prestasi[' + i + ']" />' +
			  	'</div>' +
			  	'<div class="field">' +
			  		'<label for="instansi">Instansi Pemberi</label>' +
			  		'<input type="text" name="pemberi_prestasi[' + i + ']"/>' +
			  	'</div>' +
  			'</div>');
  			$("select.dropdown").dropdown();
			i++;
